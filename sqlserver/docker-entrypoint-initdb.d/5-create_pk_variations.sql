...
GO
INSERT INTO geometry_columns (f_table_schema, f_table_name, f_geometry_column, coord_dimension, srid, type)
VALUES ('dbo', 'pk_variation_integer', 'geom', 2, 28992, 'POINT');
GO
...
GO
INSERT INTO geometry_columns (f_table_schema, f_table_name, f_geometry_column, coord_dimension, srid, type)
VALUES ('dbo', 'pk_variation_decimal', 'geom', 2, 28992, 'POINT');
GO
...
GO
INSERT INTO geometry_columns (f_table_schema, f_table_name, f_geometry_column, coord_dimension, srid, type)
VALUES ('dbo', 'pk_variation_numeric', 'geom', 2, 28992, 'POINT');
GO
